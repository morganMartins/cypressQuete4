...
describe("File upload and download tests", () => {
  beforeEach(() => {
   ...
   // cy.downloadFile('https://upload.wikimedia.org/wikipedia/en/a/a9/Example.jpg','cypress/fixtures','fileToUpload.jpg')
  });

  it("Upload file and download it in Zip format", () => {
    cy.get("#fileField").attachFile("cypress/fixtures/fileToUpload.jpg");
